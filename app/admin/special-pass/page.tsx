...
export default function AdminSpecialPassPage() {
  ...
  useEffect(() => {
    ...
    if (permissions.includes("manage_special_pass") || role === "admin") {
                          ...
                          filteredStudents.map((student: any) => (
                            <tr key={student.id} className="border-b hover:bg-muted/50 transition-colors">
                              ...
                              <td className="py-3 px-4 text-center">
                                <span className={`px-2 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${student.special_pass === "YES"
                        ...
                        {isLoadingLogs ? (
                          ...
                          allPasses.map((pass: any) => (
                            <tr key={pass.id} className="border-b hover:bg-muted/50 transition-colors text-sm">
                              ...
                              <td className="py-3 px-4 text-center">
                                <span className={`px-2 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${pass.status === "ACTIVE"
